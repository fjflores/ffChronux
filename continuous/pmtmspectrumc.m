function [ S, f, Serr ] = pmtmspectrumc( data, params )
% MATLAB DSP toolbox Multi-taper spectrum - continuous process
%
% Usage:
%
% [ S, f, Serr, J ] = pmtmspectrumc( data, params )
% Input: 
